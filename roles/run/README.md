...
Has to be a plain filename, starting with an alphanumeric character and
containing only characters from `A-Za-z0-9._-` (no path separators); the
role fails during initialization otherwise.
